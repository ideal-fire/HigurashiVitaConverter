Please use this C# program to convert the game assets to work with Higurashi-Vita.
	You need the .NET framework for this. Most people already have it.
	If you're on macOS or Linux, you can use Mono.
